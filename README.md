The program takes inputs from user to find the initial position of the first joint. Then, it takes the joint angles of each line segment connecting two consecutive joints as inputs. 
